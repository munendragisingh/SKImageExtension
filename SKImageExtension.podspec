...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Munendra Pratap Singh/SKImageExtension'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Munendra Pratap Singh' => 'munendra.singh@sapient.com' }
  s.source           = { :git => 'https://github.com/Munendra Pratap Singh/SKImageExtension.git', :tag => s.version.to_s }
